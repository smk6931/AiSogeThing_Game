...
class WorldLevelPartition(Base):
    ...
    image_prompt_append = Column(Text, nullable=True)
    image_prompt_negative = Column(Text, nullable=True)
    resolved_prompt = Column(Text, nullable=True)
    resolved_prompt_negative = Column(Text, nullable=True)
    prompt_resolved_at = Column(DateTime(timezone=True), nullable=True)
    created_at = Column(DateTime(timezone=True), server_default=func.now(), nullable=False)
    updated_at = Column(DateTime(timezone=True), server_default=func.now(), onupdate=func.now(), nullable=False)
...
class WorldPartitionGroup(Base):
    ...
    image_prompt_base = Column(Text, nullable=True)
    image_prompt_negative = Column(Text, nullable=True)
    prompt_inherit_mode = Column(String(16), nullable=False, server_default='append')
    centroid_lat = Column(Float, nullable=True)
    centroid_lng = Column(Float, nullable=True)
    boundary_geojson = Column(JSON, nullable=True)
