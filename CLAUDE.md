...
- [`agents/game_design/partition_texture_img2img_workflow.md`](C:/GitHub/AiSogeThing_Game/agents/game_design/partition_texture_img2img_workflow.md) — ref이미지→img2img→파티션 매핑 전체 절차, 테마별 ref 경로, 그룹 이력 (파티션 텍스처 작업 시 필독)
